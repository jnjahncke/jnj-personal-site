...
To view the final files, see my [github](https://github.com/jnjahncke/reviewer_randomizer/tree/main/rr_shiny_app). See tabs below for a how-to.
...
This was my second time using shiny and my first time using shiny for python so I had som (re)learning to do. I found the [gallery of apps](https://shiny.rstudio.com/py/gallery/) hosted on shinylive helpful to get me going.
...
Make sure the only things in your app folder are the files needed for the app. For me that's the three files listed above. Honestly this took me a long time of messing around to figure out. Don't get discouraged and good luck!
