...
```{r fig.width=8.5, fig.height=12, echo = TRUE}
waldo_plot + inset_element(inset, 
                           left = 0.32, 
                           bottom = 0, 
                           right = 1, 
